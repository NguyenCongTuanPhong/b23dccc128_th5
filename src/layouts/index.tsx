...
import { TeamOutlined, UserOutlined, BookOutlined, HomeOutlined, FormOutlined } from '@ant-design/icons';
	...
	return (
		<Layout style={{ minHeight: '100vh' }}>
			<Sider theme='light' width={200}>
				<div style={{ height: 64, padding: '16px', fontWeight: 'bold', fontSize: '18px' }}>LẬP TRÌNH WEB - RIPT</div>
				<Menu
					mode='inline'
				...
				<Content style={{ margin: 0, padding: 0, background: '#f5f5f5' }}>
					<div
						style={{
							padding: 24,
							background: '#fff',
							minHeight: 'calc(100vh - 64px - 64px)', // trừ header + padding
						}}
					>
						{children}
					</div>
